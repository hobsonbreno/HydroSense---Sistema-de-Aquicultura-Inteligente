...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/SDK-Pico%20SDK%202.2.0-red?style=for-the-badge" alt="SDK">
</p>

<p align="center">
  <b>Projeto Final — Sistemas Embarcados e IoT</b>
</p>
...
**Vídeo Demonstrativo (5–7 min):** [https://drive.google.com/file/d/1e51nFBpVCmwORC9yHVQrp4OObZA-HNOL/view](https://drive.google.com/file/d/1e51nFBpVCmwORC9yHVQrp4OObZA-HNOL/view)  
...
1. **Custo acessível**: com investimento total estimado em ~R$ 210,00 em componentes, utilizando hardware aberto e de baixo custo (Raspberry Pi Pico W, sensores I2C genéricos, servo SG90).
...
#### 8.4.1. AHT10 — Sensor de Temperatura e Umidade
...
#### 8.4.2. VL53L0X — Sensor de Distância Time-of-Flight
...
#### 8.5.2. Módulo de Relés (3 Canais)
...
🎬 **Vídeo completo (5–7 minutos):** [Assistir no Google Drive](https://drive.google.com/file/d/1e51nFBpVCmwORC9yHVQrp4OObZA-HNOL/view)
...
12. FREERTOS. **FreeRTOS Real-Time Operating System**. Amazon Web Services. Disponível em: https://www.freertos.org/. Acesso em: jan. 2026.

13. FREERTOS. **FreeRTOS Kernel Developer Docs — RP2040 Port**. Disponível em: https://www.freertos.org/symmetric-multiprocessing-introduction.html. Acesso em: jan. 2026.
...
[https://drive.google.com/file/d/1e51nFBpVCmwORC9yHVQrp4OObZA-HNOL/view](https://drive.google.com/file/d/1e51nFBpVCmwORC9yHVQrp4OObZA-HNOL/view)
...
**Gravar no Pico W:**
```bash
picotool load -fx build/HydroSense.uf2
```
